...
const AdminEdit = () => {
    ...
    useEffect(()=>
    {
      axios.get(`https://sapdealbackend-1.onrender.com/products/edit/${id}`,{headers:{token:localStorage.getItem("token")}}).then(r=>{
    ...
    const handleUpdate=()=>
    {
        axios.patch(`https://sapdealbackend-1.onrender.com/products/edit/${id}`,current,{headers:{token:localStorage.getItem("token")}}).then(r=>
        {
            if(r.data.msg)
            {
                toast({
