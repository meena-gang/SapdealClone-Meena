...
const SinglePage=()=>{
  ...
  useEffect(()=>{
    ...
    axios.get(
      `https://sapdealbackend-1.onrender.com/products/${id}`
  ...
  // console.log(data)
      //  const { isOpen, onOpen, onClose } = useDisclosure();
        ...
        const addProduct = (data) => {
          ...
          axios.post("https://sapdealbackend-1.onrender.com/carts/addToCart",{product:{product:id,quntity:1}},{headers:{token:localStorage.getItem("token")}})
            .then((r) => {
               if(r.data.msg)
               {
